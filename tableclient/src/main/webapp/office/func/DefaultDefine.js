Ext.define('Layout.func.DefaultDefine', {
...
//    	defaultFactorProp[4].value = y;
    	...
    	this.defaultFactorDefine.name = 
    		SEQ.seq(this.NAME_FACTOR, function(newName){
    			return Layout.EventSchedule.factorStore.findRecordByKey('name', newName);
    		});
