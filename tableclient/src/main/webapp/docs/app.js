var CodeMirror = (function() {
    function v(aN, aK) {
        ...
        var ca = aE.CodeMirror = {
            ...
            setSelection: at(function(c2, c1, c0) { (c0 ? by: bx)(aU(c2), aU(c1 || c2))
            }),
            getLine: function(c0) {
                if (bs(c0)) {
                    return cG(c0).text
        ...
        function cM(c6) {
            ...
            if (z(c6, "shiftKey")) {
                c5 = l("Shift-" + c1, b2.extraKeys, b2.keyMap,
                function(c7) {
                    return bj(c7, true)
                },
                c2) || l(c1, b2.extraKeys, b2.keyMap,
                function(c7) {
        ...
        function bZ(c2, c0) {
            var c1 = l("'" + c0 + "'", b2.extraKeys, b2.keyMap,
            function(c3) {
                return bj(c3, true)
            });
            if (c1) {
        ...
        function au(df, c4, dl, c0, dm) {
            ...
            if (b2.lineWrapping) {
                ...
                cz.iter(df.line, df.line + dl.length,
                function(dn) {
                    if (dn.hidden) {
                        return
                    }
        ...
        function bJ(c3) {
            ...
            var c2 = c3.ch,
            c0 = c3.ch;
            while (c2 > 0 && ah(c1.charAt(c2 - 1))) {--c2
            }
            while (c0 < c1.length && ah(c1.charAt(c0))) {++c0
            }
            by({
                line: c3.line,
                ch: c2
    ...
    initComponent: function() {
        ...
        this.tpl = new Ext.XTemplate('<tpl for=".">', '<div class="item">', '<div class="icon {icon}"></div>', '<div class="meta">{[this.getMetaTags(values.meta)]}</div>', '<div class="title {[this.getCls(values.meta)]}">{name}</div>', '<div class="class">{fullName}</div>', "</div>", "</tpl>", '<div class="footer">', '<tpl if="this.getTotal()">', '<a href="#" class="prev">&lt;</a>', '<span class="total">{[this.getStart()+1]}-{[this.getEnd()]} of {[this.getTotal()]}</span>', '<a href="#" class="next">&gt;</a>', "<tpl else>", '<span class="total">Nothing found</span>', "</tpl>", "</div>", {
            ...
            getMetaTags: function(b) {
                return Ext.Array.map(Docs.data.signatures,
                function(a) {
...
Ext.define("Docs.view.comments.HeaderMenu", {
    ...
    afterRender: function() {
        this.callParent(arguments);
        Ext.Array.forEach(["users", "targets", "tags"],
        function(d) {
...
Ext.define("Docs.view.examples.InlineToolbar", {
    ...
    activateButton: function(b) {
        Ext.Array.each(this.query("button"),
        function(a) {
            a.removeCls("active")
        });
...
Ext.define("Docs.controller.Examples", {
    ...
    getExample: function(b) {
        if (!this.map) {
            this.map = {};
            Ext.Array.forEach(Docs.data.examples,
            function(a) {
                Ext.Array.forEach(a.items,
                function(d) {
...
Ext.define("Docs.controller.Videos", {
    ...
    getVideo: function(b) {
        if (!this.map) {
            this.map = {};
            Ext.Array.forEach(Docs.data.videos,
            function(a) {
                Ext.Array.forEach(a.items,
                function(d) {
                    this.map[d.name] = d
...
Ext.define("Docs.controller.Tabs", {
    ...
    onLaunch: function() {
        this.getDoctabs().setStaticTabs(Ext.Array.filter([this.getWelcomeIndex().getTab(), this.getClassIndex().getTab(), this.getGuideIndex().getTab(), this.getVideoIndex().getTab(), this.getExampleIndex().getTab(), this.getTestsIndex().getTab()],
        function(a) {
            return a
        }));
...
Ext.define("Docs.controller.InlineExamples", {
    ...
    replaceExampleDivs: function() {
        Ext.Array.each(Ext.query(".inline-example"),
        function(b) {
...
Ext.define("Docs.view.cls.InheritanceLogic", {
    ...
    getSubclasses: function(b) {
        ...
        return Ext.Array.map(this.subclasses[b],
        function(a) {
    ...
    stripPrivateClasses: function(b) {
        b.children = Ext.Array.filter(b.children,
        function(a) {
...
Ext.define("Docs.view.cls.Tree", {
    ...
    expandLonelyNode: function(d) {
        var c = Ext.Array.filter(d.children,
        function(a) {
...
Ext.define("Docs.view.comments.Expander", {
    ...
    reload: function() {
        Docs.Comments.load(this.target,
        function(b) {
            this.list.load(b)
        },
        this)
...
Ext.define("Docs.view.comments.RepliesExpander", {
    ...
    loadComments: function() {
        ...
        Docs.Comments.loadReplies(this.parentId,
        function(b) {
            this.list.load(b)
        },
        this)
...
Ext.define("Docs.view.comments.List", {
    ...
    afterRender: function() {
        ...
        this.delegateClick("a.voteCommentUp",
        function(d, c) {
            this.vote(d, c, "up")
        },
        this);
        this.delegateClick("a.voteCommentDown",
        function(d, c) {
            this.vote(d, c, "down")
        },
        this);
        this.delegateClick("a.editComment",
        function(d, c) {
            this.edit(d, c)
        },
        this);
        this.delegateClick("a.deleteComment",
        function(d, c) {
...
Ext.define("Docs.view.comments.Index", {
    ...
    initComponent: function() {
        ...
        this.down("commentsHeaderMenu").on("select",
        function(a) {
            Ext.Object.each(c,
            function(b, f) {
                if (b !== a) {
    ...
    initComponent: function() {
        ...
        this.tpl = new Ext.XTemplate("<table>", "<tr>", "<td>", '<tpl for=".">', '<div class="item">', "{[this.renderLink(values)]}", "</div>", '<tpl if="xindex % this.columnHeight === 0 && xcount &gt; xindex">', "</td><td>", "</tpl>", "</tpl>", "</td>", "</tr>", "</table>", {
            ...
            renderLink: function(e) {
                var d = Ext.Array.map(Docs.data.signatures,
                function(a) {
...
Ext.define("Docs.view.HoverMenuButton", {
    ...
    deferShowMenu: function() {
        ...
        Docs.view.HoverMenuButton.showTimeout = Ext.Function.defer(function() {
            ...
            Ext.Array.forEach(Docs.view.HoverMenuButton.menus,
            function(a) {
                if (a !== this.menu) {
                    a.hide()
                }
...
Ext.define("Docs.view.cls.Toolbar", {
    ...
    showMenuItems: function(d, e, f) {
        Ext.Array.forEach(["cfg", "property", "method", "event"],
        function(b) {
    ...
    refreshMenuCommentCounts: function() {
        Ext.Object.each(this.memberButtons,
        function(c, d) {
...
Ext.define("Docs.view.cls.Overview", {
    ...
    initComments: function() {
        ...
        this.memberWrappers = {};
        Ext.Array.forEach(Ext.query(".member"),
        function(c) {
    ...
    updateCommentCounts: function() {
        ...
        Ext.Object.each(this.memberWrappers,
        function(a, d) {
    ...
    filterMembers: function(h, e) {
        ...
        Ext.Array.forEach(Ext.query(".members-section"),
        function(b) {
    ...
    buildAccessorsMap: function(c) {
        var d = {};
        Ext.Array.forEach(this.docClass.members.cfg,
        function(b) {
    ...
    getVisibleElements: function(e, d) {
        var f = Ext.Array.map(Ext.query(e, d),
        function(a) {
            return Ext.get(a)
        });
        return Ext.Array.filter(f,
        function(a) {
            return a.isVisible()
        })
    },
    eachMember: function(c, d) {
        Ext.Array.forEach(["members", "statics"],
        function(a) {
            Ext.Object.each(this.docClass[a],
            function(b, f) {
...
Ext.define("Docs.view.comments.ListWithForm", {
    ...
    subscribe: function(b) {
        Docs.Comments.subscribe(this.target, b,
        function() {
...
(function() {
    function d(F) {
        ...
        function A(J) {
            ...
            for (P = 0; P < M.length; ++P) {
                L = M[P],
                I.push(C(L[0])),
                L[1] > L[0] && (L[1] + 1 > L[0] && I.push("-"), I.push(C(L[1])))
            }
            I.push("]");
            return I.join("")
        }
        function E(J) {
            ...
            for (O = 1; O < N.length; ++O) { - 1 === N[O] && (N[O] = ++G)
            }
            for (L = O = 0; O < I; ++O) {
                K = M[O],
                K === "(" ? (++L, N[L] === void 0 && (M[O] = "(?:")) : "\\" === K.charAt(0) && (K = +K.substring(1)) && K <= L && (M[O] = "\\" + N[L])
            }
            for (L = O = 0; O < I; ++O) {
                "^" === M[O] && "^" !== M[O + 1] && (M[O] = "")
            }
            if (J.ignoreCase && H) {
                for (O = 0; O < I; ++O) {
                    K = M[O],
                    J = K.charAt(0),
                    K.length >= 2 && J === "[" ? M[O] = A(K) : J !== "\\" && (M[O] = K.replace(/[A-Za-z]/g,
                    function(P) {
                        P = P.charCodeAt(0);
    ...
    function h(u, k) {
        function x(P) {
            for (var F = P.d, C = [F, "pln"], L = 0, J = P.a.match(A) || [], B = {},
            E = 0, N = J.length; E < N; ++E) {
                var K = J[E],
                O = B[K],
                D = void 0,
                M;
        ...
        A;
        (function() {
            for (var G = u.concat(k), B = [], F = {},
            H = 0, E = G.length; H < E; ++H) {
                var D = G[H],
                I = D[3];
                if (I) {
    ...
    function o(u) {
        ...
        var u = J.createElement("OL"); u.className = "linenums";
